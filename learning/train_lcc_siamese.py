...
parser.add_argument('--outf', type=str, default='cls_lcc_embedder', help='output folder')
parser.add_argument('--embedding_model', type=str, default='', help='pretrained embedding model to start with')
parser.add_argument('--dataset', type=str, required=True, help="dataset path")
parser.add_argument('--timestamps', type=str, default=None, help='timestamps file for labels')
...
dataset = train_helpers.load_lcc_dataset(opt.dataset, opt.timestamps)
...
for epoch in range(opt.nepoch):
    ...
    for i, data in tqdm(enumerate(dataloader, 0)):
        ((labels, clouds, _), (similar_labels, similar_clouds, _), (distant_labels, distant_clouds, _)) = data
