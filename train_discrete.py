...
parser.add_argument('--outf', type=str, default='cls_discrete', help='output folder')
...
dataset = helpers.load_discrete_dataset(opt.dataset, opt.train_set, opt.distance_cache)
...
embedder = helpers.create_embedder_discrete(opt.embedding_model)
embedder.train()
